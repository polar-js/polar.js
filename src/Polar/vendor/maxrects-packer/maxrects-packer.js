(function (global, factory) {
    ...
    class MaxRectsBin extends Bin {
        constructor(maxWidth = EDGE_MAX_VALUE, maxHeight = EDGE_MAX_VALUE, padding = 0, options = { smart: true, pot: true, square: true, allowRotation: false, tag: false, border: 0, logic: exports.PACKING_LOGIC.MAX_AREA }) {
            super();
